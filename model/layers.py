# ------------------------------------------------------------------------------
#   @brief:
#       it is the file written by carpedm20, from
#       https://github.com/carpedm20/deep-rl-tensorflow/tree/master/networks
# ------------------------------------------------------------------------------
...
def linear(input_, output_size,
    ...
    '''
        @brief:
            just a simple interface that simplify how to build a fc layer
    '''
